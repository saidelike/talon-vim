...
file save as:
    key(escape)
    user.vim_run_command(":w ")
# XXX - This should be vim_mode_command, but there's a bug in at lest
...
swap (paragraph | graph):
    ...
    user.vim_run_normal("p")
patch <user.key_unmodified>:
    user.vim_run_any_motion("r{key_unmodified}")
...
shoot <user.key_unmodified>:
    user.vim_run_any_motion("f{key_unmodified}")
...
[copy] register <user.key_unmodified> [in] to [register] <user.key_unmodified>:
    user.vim_run_command(":let@{key_unmodified_2}=@{key_unmodified_1}\n")

yank (into | to) [register] <user.key_unmodified>:
    user.vim_run_any_motion('"{key_unmodified}y')
clear into [register] <user.key_unmodified>:
    user.vim_run_any_motion('"{key_unmodified}d')
...
yank <user.vim_text_objects> (into | to) [register] <user.key_unmodified>:
    user.vim_run_any_motion('"{key_unmodified}y{vim_text_objects}')
clear <user.vim_text_objects> (into | to) [register] <user.key_unmodified>:
    user.vim_run_any_motion('"{key_unmodified}d{vim_text_objects}')
...
till <user.ordinals> <user.key_unmodified>:
    user.vim_run_any_motion("t{key_unmodified}{ordinals};")

till (reversed | previous) <user.ordinals> <user.key_unmodified>:
    user.vim_run_any_motion("T{key_unmodified}{ordinals};")

find <user.ordinals> <user.key_unmodified>:
    user.vim_run_any_motion("f{key_unmodified}{ordinals-1};")
...
prefix <user.key_unmodified>:
    user.vim_run_normal("I{key_unmodified}")
squish:
    user.vim_run_command(":s/  / /g\n")
...
go first <user.key_unmodified>:
    user.vim_run_normal_np("^f{key_unmodified}")

    # XXX - should be switched to support any motion mode, but needs np
    # which isn't supported yet
go last <user.key_unmodified>:
    user.vim_run_normal_np("$F{key_unmodified}")
